(function () {
  angular.module("angular-bacon", []).run([
    ...
    function ($rootScope, $parse) {
      ...
      Object.getPrototypeOf($rootScope).$watchAsProperty = function (
        watchExp,
        objectEquality
      ) {
        return watcherBus(this, watchExp, objectEquality, "$watch");
      };
      Object.getPrototypeOf($rootScope).$watchCollectionAsProperty = function (
        watchExp,
        objectEquality
      ) {
        return watcherBus(this, watchExp, objectEquality, "$watchCollection");
      };
      Object.getPrototypeOf($rootScope).digestObservables = function (
        observables
      ) {
        var self;
        self = this;
